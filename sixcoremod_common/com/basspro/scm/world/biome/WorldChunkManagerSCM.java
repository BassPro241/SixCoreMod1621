...
public class WorldChunkManagerSCM {
    ...
    private BiomeCacheSCM biomeCache;

    /** A list of biomes that the player can spawn in. */
    private List biomesToSpawnIn;

    protected WorldChunkManagerSCM()
    {
        this.biomeCache = new BiomeCacheSCM(this);
        this.biomesToSpawnIn = new ArrayList();
        this.biomesToSpawnIn.addAll(allowedBiomes);
    }

    public WorldChunkManagerSCM(long par1, WorldType par3WorldType)
    {
        this();
    ...
    public WorldChunkManagerSCM(World par1World)
    {
    ...
    public BiomeGenBase[] getBiomeGenAt(BiomeGenBase[] par1ArrayOfBiomeGenBase, int par2, int par3, int par4, int par5, boolean par6)
    {
        ...
        {
            BiomeGenBaseSCM[] abiomegenbase1 = this.biomeCache.getCachedBiomes(par2, par3);
