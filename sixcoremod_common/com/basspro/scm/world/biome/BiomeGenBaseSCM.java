...
import com.basspro.scm.event.terraingen.BiomeEventSCM;

import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public abstract class BiomeGenBaseSCM {
    ...
    /** The biome decorator. */
    public BiomeDecoratorSCM theBiomeDecorator;
    ...
    public BiomeGenBaseSCM(int par1)
    {
     ...
     */
    public BiomeDecoratorSCM createBiomeDecorator()
    {   
        return getModdedBiomeDecorator(new BiomeDecoratorSCM(this));
    }

    /**
     * Sets the temperature and rainfall of this biome.
     */
    public BiomeGenBaseSCM setTemperatureRainfall(float par1, float par2)
    {
     ...
     */
    public BiomeGenBaseSCM setMinMaxHeight(float par1, float par2)
    {
        this.minHeight = par1;
        this.maxHeight = par2;
        return this;
     ...
     */
    public BiomeGenBaseSCM setDisableRain()
    {
     ...
     */
    public BiomeGenBaseSCM setEnableSnow()
    {
        this.enableSnow = true;
        return this;
    }

    public BiomeGenBaseSCM setBiomeName(String par1Str)
    {
        this.biomeName = par1Str;
        return this;
    }

    public BiomeGenBaseSCM func_76733_a(int par1)
    {
        this.field_76754_C = par1;
        return this;
    }

    public BiomeGenBaseSCM setColor(int par1)
    {
        this.color = par1;
        return this;
    }
    ...
    public BiomeDecoratorSCM getModdedBiomeDecorator(BiomeDecoratorSCM original)
    {
        BiomeEventSCM.CreateDecorator event = new BiomeEventSCM.CreateDecorator(this, original);
    ...
    {
        BiomeEventSCM.GetWaterColor event = new BiomeEventSCM.GetWaterColor(this, waterColorMultiplier);
    ...
    {
        BiomeEventSCM.GetGrassColor event = new BiomeEventSCM.GetGrassColor(this, original);
        MinecraftForge.EVENT_BUS.post(event);
        return event.newColor;
    }
    ...
    {
        BiomeEventSCM.GetFoliageColor event = new BiomeEventSCM.GetFoliageColor(this, original);
        MinecraftForge.EVENT_BUS.post(event);
        return event.newColor;
    }
}
